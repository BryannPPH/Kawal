      ...
      <div className="space-y-8">
        ...
        <section className="rounded-lg border border-[#F3D7C8] bg-white p-5 sm:p-6">
          ...
          <div className="mt-6 space-y-4">
            ...
            {tasks.map((task) => (
              <div key={task.id} className="rounded-lg border border-[#F3D7C8] bg-white p-5 transition hover:border-[#FD7124]/55 hover:bg-[#FFF8F4]">
                <div className="grid gap-4 lg:grid-cols-[minmax(0,1.25fr)_120px_150px_110px_44px] lg:items-center">
                  ...
                  <button
                    ...
                    className="inline-flex h-10 w-10 items-center justify-center rounded-md border border-[#F3D7C8] bg-white text-[#C95119] transition hover:bg-[#FFEFE6]"
...
function TaskDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#292622]/45 px-4 py-6" role="dialog" aria-modal="true" aria-labelledby="task-detail-title">
      <div className="max-h-[88vh] w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-[0_24px_70px_rgba(41,38,34,0.2)]">
        <div className="flex items-start justify-between gap-4 border-b border-[#F3D7C8] px-5 py-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[#F3D7C8] bg-white text-[#776B63] transition hover:bg-[#FFEFE6] hover:text-[#2F2C2A]"
        ...
        <div className="max-h-[calc(88vh-76px)] overflow-y-auto px-5 py-5">
          ...
          <div className="mt-4 rounded-md bg-[#FFF8F4] p-4">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            {task.schedulerRecommendation.selectedWorkerRecommendations.map((worker) => (
              <div key={worker.workerId} className="rounded-md border border-[#F3D7C8] bg-white px-3 py-3">
          ...
          {task.schedulerRecommendation.safetyAndOperationalWarnings.length > 0 ? (
            <div className="mt-4 rounded-md border border-[#F3D7C8] bg-white px-3 py-3">
          ...
          <div className="mt-4 flex flex-col gap-3 border-t border-[#F3D7C8] pt-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            {task.owner === 'Unassigned' ? (
              <button
                ...
                className="inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-md bg-[#FD7124] px-3 text-xs font-semibold text-white transition hover:bg-[#E85F18] disabled:cursor-not-allowed disabled:opacity-50"
              >
                <UserCheck size={15} />
